...
pluralCaseList.push( {plural: "loanRequests", pascal: "LoanRequest"} )

pluralCaseList.push( {plural: "loanAuths", pascal: "LoanAuth"} )

pluralCaseList.push( {plural: "loanManagers", pascal: "LoanManager"} )


pluralCaseList.push( {plural: "loanStatuses", pascal: "LoanStatus"} )
pluralCaseList.push( {plural: "loanMessengers", pascal: "LoanMessenger"} )
