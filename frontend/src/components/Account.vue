...
<v-card style="width:300px; margin-left:5%;" outlined>
    ...
    <v-card-text style = "margin-left:-15px; margin-top:10px;">
          ...
          <div class="grey--text ml-4" v-if="editMode" style = "margin-top:-20px;">
            <v-text-field type="number" label="BankRequestId" v-model="value.bankRequestId"/>
          </div>
          <div class="grey--text ml-4" v-else>
            BankRequestId :  {{value.bankRequestId }}
          </div>
          <div class="grey--text ml-4" v-if="editMode" style = "margin-top:-20px;">
            <v-text-field type="number" label="RequestMoney" v-model="value.requestMoney"/>
          </div>
          <div class="grey--text ml-4" v-else>
            RequestMoney :  {{value.requestMoney }}
          </div>
